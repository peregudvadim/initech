...
@Configuration
@ComponentScan("by.peregud.initech.llc")
@PropertySource("file:/opt/properties/rhr/application.properties")
@EnableTransactionManagement(proxyTargetClass = true)
@EnableJpaRepositories(basePackages = "by.peregud.initech.llc.repository")
public class ApplicationConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("by.peregud.initech.llc.entity");
